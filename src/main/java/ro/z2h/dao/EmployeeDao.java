...
public class EmployeeDao {
    ...
    public void updateEmployee(Employee employee, Connection con)throws SQLException{

    }

    public void saveEmployee(Employee employee, Connection con)throws SQLException{
